# -*- coding: utf-8 -*-
"""
Created on Wed Sep  4 10:16:22 2024
...
for numerator in range(0,50):
    ...
    records=pd.read_excel(r"data/resultados/col_tria"+str(numerator)+".xlsx")
    

    """
    records=records[records["value_thousand_dolar"]<=100]
    
    records=records[records["value_thousand_dolar"]>=0.01]
    """
    ...
    try:
        with open(r'model_saved_torch\modelxgboosterror.pkl', "rb") as input_file:
    ...
    if True:
        for i in range(0,1):
            ...
            pickle.dump(reg, open(r'model_saved_torch\modelxgboosterror.pkl','wb'))
    else:
        ...
